...
namespace KiwigoldBot.Interfaces
{
    public interface IBotMessenger
    {
        ...
        public Task SendPhotoAsync(string photoId, IReplyMarkup? replyMarkup = null, BotTargetChat targetChat = BotTargetChat.Bot, CancellationToken cancellationToken = default);
